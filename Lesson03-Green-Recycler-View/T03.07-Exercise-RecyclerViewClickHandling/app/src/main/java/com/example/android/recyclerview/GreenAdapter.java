...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    fina private ListItemClickListener mOnClickListener;
    /*
     ...
     */
    public GreenAdapter(int numberOfItems, ListItemClickListener onClickListenr) {
        mNumberItems = numberOfItems;
        viewHolderCount = 0;
        mOnClickListener = onClickListenr;
    }
